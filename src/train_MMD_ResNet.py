...
'''
# save models
autoencoder.save(os.path.join(io.DeepLearningRoot(),'savedModels/person2_3month_DAE.h5'))                 
calibMMDNet.save_weights(os.path.join(io.DeepLearningRoot(),'savedModels/person2_3month_ResNet_weights.h5'))  
'''
